    ...
    return (
        <View className="flex flex-1 relative">
                ...
                className="absolute h-full w-full" />
            {
                                    ...
                                    locations.map((loc, index) => {
                                        ...
                                        return (
                                            <TouchableOpacity
                                                ...
                                                key={index}
                                                className={"flex-row item-center border-0 p-2 px-4 mb-1" + borderClass}
                                            >
                ...
                <View className ="flex justify-around flex-1 mx-4 mb-20">
                    {/* location */}
                    ...
                    <View className="space-y-2">
                        <Text className="text-center font-bold text-white text-6xl ml-6 mt-3">
                            {current?.temp_c}&#176;
                        </Text>
